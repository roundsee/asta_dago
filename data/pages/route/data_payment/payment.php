                                                    ...
                                                    <table id="example1" class="table table-bordered table-striped">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            $sql1 = mysqli_query($koneksi, "
                                                               SELECT barang.nama, 
                                                               ((pd.nilai* pd.jml) - pd.disc)+(pembelian.ppn * (((pd.nilai* pd.jml) - pd.disc)* pembelian.tarif_ppn / 100 ))+pembelian_invoice.ongkir as hargatotal,
                                                               pembelian.kd_po,
                                                            ...
                                                            ?>
                                                                <tr align="left">
                                                                    ...
                                                                    <td style="text-align:left;"><?php echo ($jatuh_tempo); ?></td>
