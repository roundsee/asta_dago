...
$rute_detail_keuangan = 'purchase_order_detail';
                                            ...
                                            <div class="box-body">
                                                <div class="table-responsive">
                                                    ...
                                                    <?php if ($login_hash != 21) { ?>
                                                        ...
                                                        <table id="example1" class="table table-bordered table-striped">
                                                            <thead style="background-color:  lightgray;" class="elevation-2">
                                                                <tr>
                                                                    ...
                                                                    <!-- <th>Total Tagihan Harus Dibayar</th> -->
                                                        ...
                                                        LEFT JOIN supplier on supplier.kd_supp = $tabel.kd_supp
                                                        WHERE status_pembelian = 4  
                                                        ");
                                                                ...
                                                                while ($s1 = mysqli_fetch_array($sql1)) {
                                                                    $sql2 = mysqli_query($koneksi, "
                                                                        SELECT 
                                                                        (SELECT $tabel2.disc FROM $tabel2 WHERE $tabel2.kd_beli = '{$s1['kd_beli']}' limit 1 ) AS tot_disc,
                                                                        (SELECT $tabel2.jml  *  $tabel2.price FROM $tabel2 WHERE $tabel2.kd_beli = '{$s1['kd_beli']}' limit 1 )  AS tot_price,
                                                                        (SELECT (penerimaan_barang.jumlah_datang * $tabel2.jumlah_pcs *  $tabel2.price) + pembelian_invoice.ongkir
                                                                        FROM $tabel2
                                                                        ...
                                                                        WHERE $tabel2.kd_beli = '{$s1['kd_beli']}' limit 1) AS tot_price_datang
                                                                    ...
                                                                    // Pastikan subtotal_datang tidak double dengan menghindari SUM(DISTINCT) yang digandakan
                                                                ...
                                                                ?>
                                                                    <tr align="left">
                                                                        ...
                                                                        <td><?php echo $no; ?></td>
                                                                        <td><a href="main.php?route=<?php echo $rute_detail_keuangan; ?>&act&id=<?php echo $s1[$f1]; ?>&asal=<?php echo $rute; ?>" title="Detail"><?php echo $s1['kd_po']; ?></a></td>
                                                                        <td><?php echo $s1[$f9]; ?></td>
                                                                        <td><?php echo $s1[$f3]; ?></td>
                                                                        <td><?php echo $s1['namasupplier'] ?: 'Unknown Supplier'; ?></td>
                                                                        ...
                                                                        <!-- <td style="text-align:right;"><?php echo format_rupiah($subtotal_datang); ?></td> -->
                                                                        <?php if ($login_hash != 21) { ?>
                                                                            <td>
                                                                                <?php if ($s1[$f8] == 1) { ?>
                                                                                    ...
                                                                                    <?php } else { ?>
                                                                                        ...
                                                                                        <?php } else { ?>
                                                                                            <a href="main.php?route=<?php echo $rute_detail2; ?>&act&id=<?php echo $s1[$f1]; ?>&asal=<?php echo $rute; ?>" title="edit Detail">
                                                                                                ...
                                                                                                <button class="btn btn-success btn-sm elevation-2" disabled type="button" style="opacity: .7;" data-toggle="modal" data-target="#modalDetail<?php echo $s1[$f1]; ?>">
                                                                                                    <i class="fa fa-check"></i> invoice sudah dibuat
                                                                                                </button>
                                                                                            </a>
                                                                                        <?php } ?>
                                                                                    <?php } ?>
