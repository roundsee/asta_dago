                                                    ...
                                                    <?php if ($login_hash != 21) { ?>
                                                        ...
                                                        <table id="example1" class="table table-bordered table-striped">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                $tabel.tgl_po ,$tabel.kd_supp, b.nama AS nama_barang , pd.kd_brg as kd_brg , pd.jumlah_pcs as jumlah_pcs, supplier.nama as nama_supplier
                                                                from $tabel
                                                                LEFT JOIN supplier on supplier.kd_supp = $tabel.kd_supp 
                                                                LEFT JOIN pembelian_detail pd ON pd.kd_beli = $tabel.kd_beli
                                                                        ...
                                                                        <?php if ($login_hash != 21) { ?>
                                                                            <td>
                                                                                ...
                                                                                <?php } elseif ($s1[$f8] == 2) { ?>
                                                                                    ...
                                                                                    <a href="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=batal_rilis_po&id=<?php echo $s1[$f1]; ?>" title="Batal_Rilis_Po" type="button" onclick="return confirm('Apakah anda yakin ingin membatalkan PO ini ?')">
                                                                                        <button class="btn btn-danger btn-sm elevation-2" type="button" style="opacity: .7;width:120px">
                                                                                            <i class="fa fa-trash"></i> Batal Rilis PO
                                                                                        </button>
                                                                                    </a>
                                                                                <?php } elseif ($s1[$f8] == 3) { ?>
                                                                                    <a href="route/<?php echo $data; ?>/cetak.php?kd_beli=<?php echo $s1['kd_beli']; ?>">
                                        ...
                                        <div class="col-lg-2">
                                          <div class="form-group">
                                            ...
                                            <input type="text" name="<?php echo $f8; ?>" class="form-control" value="<?php echo $e[$f8]; ?>" autofocus="" required="" />
                                                ...
                                                <a href="main.php?route=<?php echo $rute; ?>&act&ide=<?php echo $en; ?>&asal=<?php echo $rute; ?>"><button class="btn btn-primary btn-sm elevation-1" style="opacity: .7">Back</button></a>
                                            </div><!-- /.box-body -->
                                        </div><!-- /.box -->
                                    </div><!--/.col (right) -->
                                </div> <!-- /.row -->
