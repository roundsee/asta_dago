...
?>
    <script>
        function displayResultVoucher(qtyorderto) {
            console.log("Fungsi dipanggil dengan nilai:", qtyorderto);
            const elem = document.getElementById("voucherresult");
            if(elem) {
                elem.value = qtyorderto;
            } else {
                console.error("Elemen voucherresult tidak ditemukan!");
            }
        }
    </script>
    <?php
if (isset($_GET['act'])) {
    ...
    $act = 'data_generate_stok'; // Paksa default jika kosong
}
echo "ACT" . $act;
    switch ($_GET['act']) {
        //Tampil Data 
                ...
                <section class="content-header  wow fadeInDown" data-wow-duration=".3s" data-wow-delay=".3s">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="list-gds">
                                    <b><?php echo $judulform; ?></b> <small style="font-weight: 100;">report xxx</small>
                                </h1>
                            </div>
                            <div class="col-sm-6">
                                                    ...
                                                    <?php if ($filter == 'semua'  && $qtyorder == 'tertinggi') { ?>
                                                        <form id="invoiceForm" action="route/<?php echo $data; ?>/generate_stock_order.php?tgl_awal=<?php echo $tgl_awal; ?>&tgl_akhir=<?php echo $tgl_akhir; ?>&filter=<?php echo $filter; ?>&nilai=<?php echo $nilai; ?>&judul=<?php echo $judul; ?>*&act=keduanya" method="post"> <!-- Form untuk proses penyimpanan -->
                                                            ...
                                                            <table id="example" class="table table-bordered table-striped">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $query_kd_brg = "SELECT DISTINCT kd_brg FROM barang where  kd_subgrup is null";
                                                            ...
                                                            <table id="example" class="table table-bordered table-striped">
                                                                <thead style="background-color: lightgray;" class="elevation-2">
                                                                    <tr style="text-align: center;">
                                                                        ...
                                                                        <th rowspan="2">Buffer</th>
                                                                        <th rowspan="2">Nilai buffer</th>
                                                                        <th rowspan="2">Stock Minimum</th>
                                                                        <th rowspan="2">Stok Diinginkan</th>
                                                                        <th rowspan="2">Inventory Stock</th>

                                                                        <th style="text-align: center; background-color:#B0BEC5;" colspan="4">Total penjualan per minggu dalam 28 hari</th>
                                                                        <th rowspan="2">Rata-rata penjualan perminggu dalam 4 minggu</th>
                                                                        <th rowspan="2">Waktu Kirim berdasarkan barang</th>
                                                                        <th rowspan="2">Stock Diinginkan - Stock Inventory</th>
                                                                        <th rowspan="2">Minimum Order</th>
                                                                        <th rowspan="2">Barang yang harus dipesan</th>
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    //$query_kd_brg = "SELECT DISTINCT kd_brg FROM barang where kd_brg = '8993351122625'";
                                                                    ...
                                                                    if ($result_kd_brg && mysqli_num_rows($result_kd_brg) > 0) {
                                                                        ...
                                                                        while ($row_kd_brg = mysqli_fetch_assoc($result_kd_brg)) {
                                                                            ...
                                                                            //rata2 penjualan perminggu = total 4 minggu/4
                                                                            $rata_perminggu = ($total_minggu_I + $total_minggu_II + $total_minggu_III + $total_minggu_IV)/4;
                                                                            ...
                                                                            //Stock Minimum = rata2 penjualan per minggu * waktu kirim
                                                                            $stock_minimum = $rata_perminggu * $waktu_kirim_supplier/7;
                                                                            ...
                                                                            $buffer = $rata_perminggu * ($nilai_buffer / 100);
                                                                            //Stock Diinginkan
                                                                            $stok_akhir = $stock_minimum + $buffer;
                                                                            $kekuranganstock=0;
                                                                            if($stok_akhir > $perhitungan_stok_akhir){
                                                                            $kekuranganstock = $stok_akhir - $perhitungan_stok_akhir;
                                                                            }
                                                                            $qty_order=0;
                                                                            if($kekuranganstock > 0){
                                                                                if($kekuranganstock < $minimum_order){
                                                                                    $qty_order = $minimum_order;
                                                                                }else{
                                                                    ...
                                                                    ?>
                                                                            <tr align="left">
                                                                                ...
                                                                                <td><?php echo $kd_brg; ?></td>
                                                                                <td><?php echo $nama_barang; ?></td>
                                                                                <td style="text-align:right;"><?php echo number_format($buffer,2); ?></td>
                                                                                <td style="text-align:right;"><?php echo number_format($nilai_buffer,2); ?> %</td>
                                                                                <td style="text-align:right;"><?php echo number_format($stock_minimum,2); ?></td>
                                                                                <td style="text-align:right;"><?php echo number_format($stok_akhir,2); ?></td>
                                                                                <td style="text-align:right;"><?php echo number_format($perhitungan_stok_akhir,2); ?></td>
                                                                                <td style="background-color: rgba(207, 216, 220, 0.6); text-align:right;"><?php echo number_format($total_minggu_I,2); ?></td>
                                                                                <td style="background-color: rgba(207, 216, 220, 0.6); text-align:right;"><?php echo number_format($total_minggu_II,2); ?></td>
                                                                                <td style="background-color: rgba(207, 216, 220, 0.6); text-align:right;"><?php echo number_format($total_minggu_III,2); ?></td>
                                                                                <td style="background-color: rgba(207, 216, 220, 0.6); text-align:right;"><?php echo number_format($total_minggu_IV,2); ?></td>
                                                                                <td style="text-align:right;"><?php echo number_format($rata_perminggu,2); ?></td>
                                                                                <td style="text-align:right;"><?php echo $waktu_kirim_supplier . " Hari"; ?></td>
                                                                                <td style="text-align:right;">
                                                                                    <input type="radio" name="selection_<?php echo $kd_brg; ?>" value="qty_order_rata_<?php echo $kd_brg; ?>" class="largeRadio">
                                                                                    <?php echo number_format($kekuranganstock); ?>
                                                                                    ...
                                                                                    <input type="hidden" name="stok_akhir_<?php echo $kd_brg; ?>" value="<?php echo $stok_akhir; ?>">
                                                                                    <input type="hidden" name="perhitungan_stok_akhir_<?php echo $kd_brg; ?>" value="<?php echo $perhitungan_stok_akhir; ?>">
                                                                                    <input type="hidden" name="rata_minggu_I_<?php echo $kd_brg; ?>" value="<?php echo $total_minggu_I; ?>">
                                                                                    <input type="hidden" name="rata_minggu_II_<?php echo $kd_brg; ?>" value="<?php echo $total_minggu_II; ?>">
                                                                                    <input type="hidden" name="rata_minggu_III_<?php echo $kd_brg; ?>" value="<?php echo $total_minggu_III; ?>">
                                                                                    <input type="hidden" name="rata_minggu_IV_<?php echo $kd_brg; ?>" value="<?php echo $total_minggu_IV; ?>">
                                                                                    <input type="hidden" name="max_rata_per_minggu_<?php echo $kd_brg; ?>" value="<?php echo $max_rata_per_minggu; ?>">
                                                                                    <input type="hidden" name="max_tertinggi_perminggu_<?php echo $kd_brg; ?>" value="<?php echo $max_tertinggi_perminggu; ?>">
                                                                                    <input type="hidden" name="waktu_kirim_supplier_<?php echo $kd_brg; ?>" value="<?php echo $waktu_kirim_supplier; ?>">
                                                                                    <input type="hidden" name="waktu_kirim_barang_<?php echo $kd_brg; ?>" value="<?php echo $waktu_kirim_barang; ?>">
                                                                                ...
                                                                                <?php if ($qty_order > 0) { ?>
                                                                                    <td style="text-align:right;"><?php echo number_format($qty_order); ?></td>
                                                                                <?php } else { ?>
                                                                                    <td></td>
                                                                                <?php } ?>
                                                                            </tr><?php
