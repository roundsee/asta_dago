                    ...
                    <div class="box">
                      <div class="box-body">
                        <div class="table-responsive">
                          ...
                          <button class="btn btn-primary btn-sm elevation-2 " style="opacity: .7;" onclick="window.location='route/<?php echo $data; ?>/permintaan_barang_tambah.php'"><i class="fa fa-plus" ;></i> Tambah Permintaan</button>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                              ...
                              <tbody>
                                ...
                                $sql1 = mysqli_query($koneksi, "
                                  ...
                                  WHERE kd_cus_peminta = '$kd_cus' and status_permintaan <= 1
                              ");
                                ...
                                while ($s1 = mysqli_fetch_array($sql1)) {
                                  // Menghitung total harga di tabel terkait
                                  $sql2 = mysqli_query($koneksi, "
                SELECT SUM(qty_diajukan * harga) AS tot_price 
                FROM $tabel2 
                WHERE kode_permintaan = '{$s1['kode_permintaan']}'
            ");
                                  $s2 = mysqli_fetch_array($sql2);
                                  $grand_total = $s2['tot_price'];
                                  $subtotal = $grand_total; // Tidak ada nilai pajak
                                    ...
                                    <td>
                                      <?php if ($s1[$f5] == 0) { ?>
                                        <a href="main.php?route=<?php echo $rute_detail; ?>&act&id=<?php echo $s1[$f1]; ?>&asal=<?php echo $rute; ?>" title="Edit Detail">
                                          <button class="btn btn-primary btn-sm elevation-2" type="button" style="opacity: .7;">
                                      ...
                                      <?php } elseif ($s1[$f5] == 1) { ?>
                                        <button class="btn btn-secondary btn-sm" disabled><i class="fa fa-hourglass-half"></i> Proses</button>
                                        <a href="route/<?php echo $data; ?>/<?php echo $aksi; ?>.php?route=<?php echo $rute; ?>&act=selesaikan_permintaan&id=<?php echo $s1[$f1]; ?>" title="selesaikan" onclick="return confirm('Apakah anda yakin ingin permintaan akan dianggap selesai?')">
                                          <button class="btn btn-success btn-sm elevation-2" type="button" style="opacity: .7;width:180px;">
                                            <i class="fa fa-check"></i> Selesaikan Permintaan
                                          </button>
                                        </a>
      ...
      <script>
        $(document).ready(function() {
          $('#viewModal').on('show.bs.modal', function(event) {
            ...
            var nomor_pengiriman = button.data('nomor_pengiriman'); // Ambil data-nomor_pengiriman
