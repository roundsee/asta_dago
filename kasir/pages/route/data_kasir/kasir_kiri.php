		...
		<div class="table-responsive" style="padding:1px 10px 10 10px">
			...
			<div class="wrapper bg-white " style="padding: 0px 10px 1px;margin:  5 -5 -1;">
				...
				<div class="row">
					...
					write_log("CHAR");
					write_log($last4 . '-' . $tgl_inv . '-' . $kasir);
					$char = $last4 . '-' . $tgl_inv . '-' . $kasir;
					$kd_cus_tgl_inv = $last4 . '-' . $tgl_inv;

					// echo $char;
					//0499-260121-00
					$hasil = mysqli_query($koneksi, "SELECT faktur,max(faktur) as maxKode FROM penjualan where substr(faktur,1,14) ='$char' group by faktur");
